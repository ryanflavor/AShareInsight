...
using the HTTP API of the running qwen_rerank.
"""
...
class QwenRerankAdapter(RerankerPort):
    """Qwen Service HTTP adapter for document reranking.

    This adapter communicates with the qwen_rerank HTTP API
    for high-quality document reranking.
    """

    def __init__(self, config: QwenRerankConfig) -> None:
